...
const trustItems = [
  {
    ...
    description: "2012'den beri binlerce müşterinin güvenini kazandık. İstanbul genelinde şeffaf ve dürüst ticaret anlayışımızla hizmetinizdeyiz.",
  },
  {
    icon: Truck,
    title: "Hızlı Teslimat",
    description: "Aynı gün teslimat ve yerinden alım hizmeti. İstanbul Avrupa ve Anadolu yakasına hızlı ve güvenli nakliye.",
  },
  {
    icon: Sparkles,
