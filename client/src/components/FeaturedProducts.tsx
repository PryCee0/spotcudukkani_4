...
export default function FeaturedProducts() {
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-card transition-colors duration-300">
      <div className="container">
        ...
        <ScrollAnimation direction="up">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 mb-10 lg:mb-14">
            ...
            <Link href="/urunler">
              <Button variant="outline" className="gap-2 text-base lg:text-lg px-6 lg:px-8 py-3 lg:py-4 h-auto border-2 border-border hover:border-[#FFD300] hover:bg-[#FFD300]/5">
                Tüm Ürünler
        ...
        {isLoading ? (
          ...
          <ScrollAnimation direction="up">
            <div className="text-center py-16 lg:py-20 bg-background rounded-2xl transition-colors duration-300">
              <Package className="w-18 h-18 lg:w-20 lg:h-20 mx-auto text-muted-foreground/30 mb-5" />
