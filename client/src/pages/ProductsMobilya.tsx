...
import { Package, ArrowLeft, Armchair, X } from "lucide-react";
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg md:text-xl">
                Kadıköy Fikirtepe'de kaliteli ikinci el mobilya fırsatları
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="text-center py-16 bg-card rounded-2xl border border-border/50">
                  ...
                  <p className="text-muted-foreground text-sm mb-6">
                    {selectedSubCategory 
                      ...
                      : "Yakında yeni mobilya ürünleri eklenecektir."}
                  </p>
                  {selectedSubCategory ? (
